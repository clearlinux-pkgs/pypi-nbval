...
Source0  : https://files.pythonhosted.org/packages/28/be/22bd64d09e0cb53258f83b6fc455f05f18a78e3e5c109ccb6af42f1f49a2/nbval-0.11.0.tar.gz
...
%prep
%setup -q -n nbval-0.11.0
cd %{_builddir}/nbval-0.11.0
pushd ..
cp -a nbval-0.11.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1709569118
